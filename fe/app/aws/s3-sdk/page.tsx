...
import { S3SdkProvider } from "@/app/aws/s3-sdk/S3SdkProvider";
import UploadForm from "@/app/aws/s3-sdk/UploadForm";
import FileActions from "@/app/aws/s3-sdk/FileActions";

export default function S3SdkPage() {
  return (
      ...
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Upload (Presigned URL hoặc SDK), lấy presigned URL và xóa file.
            Credentials tạm do backend cấp.
          </p>
        </div>
