...
/**
 * Extra guardrail for chunk flush by approximate payload size (bytes).
 * Why: row-only chunk can be unstable when CSV rows vary greatly in length.
 */
export const PRODUCT_INSERT_CHUNK_BYTES = 1 * 1024 * 1024;
